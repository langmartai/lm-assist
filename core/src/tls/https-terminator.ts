 ...
 *     /voice/claude/page-bridge→ Core's upgrade router (headless-Chrome page bridge, loopback-only)
...
const CORE_UPGRADE_PATHS = ['/voice/stt/ws', '/voice/claude/ws', '/voice/claude/page-bridge'];
