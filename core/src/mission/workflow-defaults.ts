...
const PASS_BASE =
  ...
  'Missions marked MANUAL are being run by a human right now. Do NOT drive, answer, resume, or otherwise write to their sessions — every such call will refuse with STANDBY_MODE. Do not plan around them and do not try to switch them back; only the user can release one.';
