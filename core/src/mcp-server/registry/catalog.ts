...
mod('expanded.ts', 'terminal', [
  ...
  'windows_terminal_create', 'windows_terminal_send', 'windows_terminal_auto_handle', 'windows_terminal_close',
]);
// --- memory + rules ---
...
mod('expanded.ts', 'ccr', [
  ...
  'ccr_remote_stop', 'ccr_cloud_start', 'ccr_cloud_repos', 'ccr_cloud_drive', 'ccr_cloud_answer',
  'ccr_cloud_read', 'ccr_cloud_stop', 'ccr_cloud_list',
]);
// --- claude.ai web ---
