...
| <a href="./examples/build-your-own-mcp-plugin/"><img src="https://raw.githubusercontent.com/langmartai/lm-assist/main/examples/build-your-own-mcp-plugin/claudeai-full-auto-call-masked.png" alt="A claude.ai conversation calling a plugin tool that an agent built and enabled on the node minutes earlier"></a><br><sub>**Build your own MCP plugin, fully automatically** — one claude.ai prompt: an agent on the node builds and enables it, Claude reconnects, sets permissions, and calls it</sub> | <a href="./examples/mcp-connector-install/"><img src="https://raw.githubusercontent.com/langmartai/lm-assist/main/examples/mcp-connector-install/claude-app-connectors.png" alt="Claude desktop app — Settings → Connectors showing lm-assist langmart"></a><br><sub>**The connector, installed for you** — Settings → Connectors in the Claude app after the hub connect</sub> |
